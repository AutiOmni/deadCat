...
function handleCarousel() {
  var carouselIdx = 0;
  upCarousel(carouselIdx) // START CAROUSEL
}

function upCarousel(idx) {
  ...
  carouselInterval = setInterval(() => {
    ...
    $('.photo-container').css("transform", `translateX(-${idx * 16.66}%)`)
  }, 2500)

}
function downCarousel(idx) {
